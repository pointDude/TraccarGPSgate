...
//                    //test
//                    Location loc = new Location("mobile");
//                    loc.setLatitude(41.79066);
//                    loc.setLongitude(123.44216);
//                    loc.setTime(1558080357);
//                    Position position = new Position(preferences.getString(MainFragment.KEY_DEVICE, null), loc, 23);//
//                    write(position);
//                    send(position);
